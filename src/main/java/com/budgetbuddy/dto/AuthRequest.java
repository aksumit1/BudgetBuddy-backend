 ...
 * Supports both client-side hashed passwords (secure) and plaintext passwords (legacy)
 * 
 * Security: Client sends password_hash and salt, backend performs additional server-side hashing
 */
public class AuthRequest {
    ...
    public AuthRequest(String email, String passwordHash, String salt) {
        this.email = email;
