...
/**
 * DynamoDB table for tracking user category corrections
 * Used for learning and improving merchant categorization
 */
@DynamoDbBean
public class UserCorrectionTable {
    ...
    public void setCorrectedAtTimestamp(Long timestamp) {
    ...
    public void setOriginalCategoryPrimary(String originalCategoryPrimary) {
    ...
    public void setOriginalCategoryDetailed(String originalCategoryDetailed) {
    ...
    public void setCorrectedCategoryPrimary(String correctedCategoryPrimary) {
    ...
    public void setCorrectedCategoryDetailed(String correctedCategoryDetailed) {
    ...
    public void setCorrectedTransactionType(String correctedTransactionType) {
