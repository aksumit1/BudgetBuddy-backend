...
/**
 * DynamoDB table for user-defined custom merchant/category mappings
 * Allows users to set custom categories for specific merchants
 */
@DynamoDbBean
public class CustomMerchantMappingTable {
    ...
    public void setCategoryPrimary(String categoryPrimary) {
