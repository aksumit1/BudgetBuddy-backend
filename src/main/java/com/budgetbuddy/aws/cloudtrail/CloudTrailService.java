...
public class CloudTrailService {
    ...
    public CloudTrailService(CloudTrailClient cloudTrailClient) {
     ...
     */
    public void logApplicationActivity(String userId, String action, String resource, String result) {
     ...
     * Get trail status
     */
    public GetTrailStatusResponse getTrailStatus(String trailName) {
        try {
