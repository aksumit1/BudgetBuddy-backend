...
public class PushNotificationService {
     ...
     */
    public boolean sendPushNotification(String userId, String title, String body, Map<String, Object> data) {
        try {
     ...
     */
    public String registerDevice(String userId, String deviceToken, String platform) {
        try {
    ...
    private String getDeviceEndpointArn(String userId) {
    ...
    private String createPlatformMessage(String title, String body, Map<String, Object> data) {
