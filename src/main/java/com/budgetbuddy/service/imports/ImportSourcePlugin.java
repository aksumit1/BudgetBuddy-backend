...
/**
 * P3: Plugin interface for import sources Allows adding new import sources without modifying core
 * code
 */
public interface ImportSourcePlugin {
     ...
     */
    ImportResult parseForPreview(
            InputStream inputStream, String filename, String userId, String password);
