...
class TransactionFunctionalTest {
    ...
    void setUp() {
        ...
        testUser = userService.createUserSecure(email, passwordHash, null, null);
    ...
    void testCreateTransactionCompleteWorkflow() throws Exception {
    ...
    void testGetTransactionsWithPagination() throws Exception {
        ...
        final String testUserEmail = testUser.getEmail();
    ...
    @Test
    void testGetTransactionsInRangeWithDateRange() throws Exception {
        // Given
        final String testUserEmail = testUser.getEmail();
