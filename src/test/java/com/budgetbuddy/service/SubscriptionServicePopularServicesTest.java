...
/**
 * Test subscription detection for popular subscription services
 * Tests OpenAI, Hulu+, Uber One, and other common subscriptions
 */
...
public class SubscriptionServicePopularServicesTest {
    ...
    void setUp() {
        ...
        String testUserEmail = "test-popular-" + UUID.randomUUID() + "@example.com";
    ...
    void testOpenAISubscription() {
        ...
        Subscription openai = subscriptions.stream()
                .filter(s -> s.getMerchantName() != null && 
                           (s.getMerchantName().toLowerCase().contains("openai") ||
                            s.getMerchantName().toLowerCase().contains("chatgpt")))
                .findFirst()
                .orElse(null);
        
        assertNotNull(openai, "OpenAI subscription should be detected");
        assertEquals(Subscription.SubscriptionFrequency.MONTHLY, openai.getFrequency(), 
            "OpenAI should be detected as monthly subscription");
        assertEquals("software", openai.getSubscriptionType(), 
            "OpenAI should be detected as software subscription");
        assertTrue(openai.getAmount().abs().compareTo(new BigDecimal("22.04")) == 0 ||
    ...
    void testHuluPlusSubscription() {
        ...
        Subscription hulu = subscriptions.stream()
                .filter(s -> s.getMerchantName() != null && 
                           s.getMerchantName().toLowerCase().contains("hulu"))
                .findFirst()
                .orElse(null);
        
        assertNotNull(hulu, "Hulu subscription should be detected");
        assertEquals(Subscription.SubscriptionFrequency.MONTHLY, hulu.getFrequency(), 
            "Hulu should be detected as monthly subscription");
        assertEquals("streaming", hulu.getSubscriptionType(), 
            "Hulu should be detected as streaming subscription");
        assertTrue(hulu.getAmount().abs().compareTo(new BigDecimal("14.99")) == 0 ||
    ...
    void testUberOneSubscription() {
        ...
        Subscription uber = subscriptions.stream()
                .filter(s -> s.getMerchantName() != null && 
                           (s.getMerchantName().toLowerCase().contains("uber") ||
                            (s.getDescription() != null && s.getDescription().toLowerCase().contains("uber one"))))
                .findFirst()
                .orElse(null);
        ...
        assertTrue(uber.getAmount().abs().compareTo(new BigDecimal("9.99")) == 0 ||
    ...
    void testNetflixSubscription() {
        ...
        Subscription netflix = subscriptions.stream()
                .filter(s -> s.getMerchantName() != null && 
                           s.getMerchantName().toLowerCase().contains("netflix"))
                .findFirst()
                .orElse(null);
    ...
    void testSpotifySubscription() {
        ...
        Subscription spotify = subscriptions.stream()
                .filter(s -> s.getMerchantName() != null && 
                           s.getMerchantName().toLowerCase().contains("spotify"))
                .findFirst()
                .orElse(null);
    ...
    void testAmazonPrimeSubscription() {
        ...
        Subscription prime = subscriptions.stream()
                .filter(s -> s.getMerchantName() != null && 
                           (s.getMerchantName().toLowerCase().contains("amazon") ||
    ...
    void testDisneyPlusSubscription() {
        ...
        Subscription disney = subscriptions.stream()
                .filter(s -> s.getMerchantName() != null && 
                           (s.getMerchantName().toLowerCase().contains("disney") ||
                            s.getDescription() != null && s.getDescription().toLowerCase().contains("disney")))
                .findFirst()
                .orElse(null);
    ...
    void testAppleMusicSubscription() {
        ...
        Subscription apple = subscriptions.stream()
                .filter(s -> s.getMerchantName() != null && 
                           (s.getMerchantName().toLowerCase().contains("apple") ||
                            (s.getDescription() != null && s.getDescription().toLowerCase().contains("apple music"))))
                .findFirst()
                .orElse(null);
    ...
    void testMultipleSubscriptions() {
        ...
        long openaiCount = subscriptions.stream()
            .filter(s -> s.getMerchantName() != null && 
                       s.getMerchantName().toLowerCase().contains("openai"))
            .count();
        long huluCount = subscriptions.stream()
            .filter(s -> s.getMerchantName() != null && 
                       s.getMerchantName().toLowerCase().contains("hulu"))
            .count();
        long netflixCount = subscriptions.stream()
            .filter(s -> s.getMerchantName() != null && 
                       s.getMerchantName().toLowerCase().contains("netflix"))
            .count();
