...
/**
 * End-to-end tests for TransactionTypeCategoryService Tests the complete flow from Plaid/Import to
 * final category/type determination
 */
...
class TransactionTypeCategoryServiceE2ETest {
    ...
    @Test
    void testE2EPlaidTransactionWithCategories() {
    ...
    @Test
    void testE2ECSVImportWithAccountDetection() {
    ...
    @Test
    void testE2EInvestmentTransfer() {
    ...
    @Test
    void testE2EGlobalTransactionIndianBank() {
    ...
    @Test
    void testE2EGlobalTransactionEuropeanBank() {
    ...
    @Test
    void testE2EErrorHandlingNullInputs() {
    ...
    @Test
    void testE2EErrorHandlingInvalidAmount() {
    ...
    @Test
    void testE2EPerformanceMultipleTransactions() {
        ...
        assertTrue(
                duration < 5000, "Processing 100 transactions took too long: " + duration + "ms");
    }
}
