...
/** Integration Tests for Behavioral Analysis Tests behavioral analysis service and risk scoring */
...
class BehavioralAnalysisIntegrationTest {
    ...
    @Autowired private BehavioralAnalysisService behavioralAnalysisService;
    ...
    void testBehavioralAnalysisRecordActivitySucceeds() {
        // Given
        ...
        final BehavioralAnalysisService.BehaviorProfile profile =
                behavioralAnalysisService.getBehaviorProfile(userId);
    ...
    void testBehavioralAnalysisCalculateRiskScoreSucceeds() {
        // Given
        final String userId = testUserId;
    ...
    void testBehavioralAnalysisDetectAnomaliesSucceeds() {
        // Given
        final String userId = testUserId;
        ...
        final List<BehavioralAnalysisService.Anomaly> anomalies =
    ...
    void testBehavioralAnalysisHighSensitivityResourceHigherRiskScore() {
        // Given
        final String userId = testUserId;
        ...
        assertTrue(
                riskScore.getScore() > 0,
                "High-sensitivity resource should have positive risk score");
    }

    @Test
    @DisplayName("Risk Score for Low-Sensitivity Resource")
    void testBehavioralAnalysisLowSensitivityResourceLowerRiskScore() {
        // Given
        final String userId = testUserId;
        ...
        assertTrue(
                riskScore.getScore() < 50, "Low-sensitivity resource should have lower risk score");
    }
}
